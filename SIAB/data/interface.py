...
def get_rvdw(element: str, method: str = "0chg"):
...
def get_radius(element: str, radius_kind: str = "covalent", **kwargs):
    ...
    if radius_kind == "covalent":
        ...
        if "method" in kwargs.keys():
            return get_rvdw(element, method=kwargs["method"])
        else:
            return get_rvdw(element, method="0chg")
    else:
