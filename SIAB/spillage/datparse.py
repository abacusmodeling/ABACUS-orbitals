...
def read_wfc_lcao_txt(fname):
    ...
    16 files, with the first and last 8 files corresponding to spin-up and
    spin-down respectively. The k point in crystal coordinate is also given
...
def read_abacus_csr(fname):
    ...
    a data file and returns the corresponding matrices, as well as their
