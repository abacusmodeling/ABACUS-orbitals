import unittest
import SIAB.supercomputing.ptgfront as ptgfront

class TestToBc(unittest.TestCase):

    def test_bc_parameters(self):
        result = ptgfront.ov_parameters(element="H", 
    ...
    def test_merge_param(self):
        self.assertEqual(ptgfront.merge_ovparam(
            [
        ...
        with self.assertRaises(ValueError):
            ptgfront.merge_ovparam([{"Nt_all": "H", "Nu": [2, 2, 1], "Rcut": 2.0, "dr": 0.01, "Ecut": 2.0,
                          "lr": 0.03, "cal_T": False, "cal_smooth": True, "max_steps": 1000},
                         {"Nt_all": "He", "Nu": [3, 2, 1], "Rcut": 3.0, "dr": 0.02, "Ecut": 3.0,
    ...
    def test_ov_reference_states(self):
        result = ptgfront.ov_reference_states(
            element="H",
    ...
    def test_ov_weights(self):
        ...
        result = ptgfront.ov_weights(reference_states=reference_states)
    ...
    def test_ov_c_init(self):
        result = ptgfront.ov_c_init(orbitals=[
            {
                "nzeta": [2, 1, 1],
    ...
    def test_convert(self):
        ...
        for result in ptgfront.convert(calculation_setting=calculation_setting,
