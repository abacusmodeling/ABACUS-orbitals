import unittest
import SIAB.to_bc as to_bc

class TestToBc(unittest.TestCase):

    def test_bc_parameters(self):
        self.assertEqual(to_bc.bc_parameters("H", [2, 2, 1], 2.0, 2.0, 0.01, 1000, 0.03, False, True),
                         {"Nt_all": "H", "Nu": [2, 2, 1], "Rcut": 2.0, "dr": 0.01, "Ecut": 2.0,
                          "lr": 0.03, "cal_T": False, "cal_smooth": True, "max_steps": 1000})
    
    def test_merge_param(self):
        self.assertEqual(to_bc.merge_bcparam([{"Nt_all": "H", "Nu": [2, 2, 1], "Rcut": 2.0, "dr": 0.01, "Ecut": 2.0,
                          "lr": 0.03, "cal_T": False, "cal_smooth": True, "max_steps": 1000},
        ...
        with self.assertRaises(ValueError):
            to_bc.merge_bcparam([{"Nt_all": "H", "Nu": [2, 2, 1], "Rcut": 2.0, "dr": 0.01, "Ecut": 2.0,
                          "lr": 0.03, "cal_T": False, "cal_smooth": True, "max_steps": 1000},
                         {"Nt_all": "He", "Nu": [3, 2, 1], "Rcut": 3.0, "dr": 0.02, "Ecut": 3.0,
